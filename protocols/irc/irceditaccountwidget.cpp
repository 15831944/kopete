...
#include "ui_ircaccountpreferences.h"
#include "ircaccount.h"
#include "ircprotocol.h"

IRCEditAccountWidget::IRCEditAccountWidget( QWidget* parent, Kopete::Account* account)
: QWidget( parent ), KopeteEditAccountWidget( account )
{
	QVBoxLayout *layout = new QVBoxLayout( this );
				kDebug(14210) ;
	QWidget *widget = new QWidget( this );
	m_preferencesWidget = new Ui::ircAccountPreferences();
...
Kopete::Account* IRCEditAccountWidget::apply()
{
	...
	if ( account() )
		...
		setAccount( new IRCAccount( IRCProtocol::protocol(), accountName ) );

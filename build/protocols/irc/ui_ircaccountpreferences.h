...
/********************************************************************************
** Form generated from reading UI file 'ircaccountpreferences.ui'
**
...
#ifndef UI_IRCACCOUNTPREFERENCES_H
#define UI_IRCACCOUNTPREFERENCES_H
...
class Ui_ircAccountPreferences
{
public:
    ...
    void setupUi(QWidget *ircAccountPreferences)
    {
        if (ircAccountPreferences->objectName().isEmpty())
            ircAccountPreferences->setObjectName(QString::fromUtf8("ircAccountPreferences"));
        ircAccountPreferences->resize(362, 272);
        vboxLayout = new QVBoxLayout(ircAccountPreferences);
        vboxLayout->setSpacing(6);
        vboxLayout->setObjectName(QString::fromUtf8("vboxLayout"));
        vboxLayout->setContentsMargins(0, 0, 0, 0);
        tabWidget11 = new QTabWidget(ircAccountPreferences);
        ...
        labelStatusMessage = new QLabel(ircAccountPreferences);
        ...
        retranslateUi(ircAccountPreferences);

        QMetaObject::connectSlotsByName(ircAccountPreferences);
    } // setupUi

    void retranslateUi(QWidget *ircAccountPreferences)
    {
        ircAccountPreferences->setWindowTitle(tr2i18n("Account Preferences - irc", 0));
        ...
        textLabel12->setText(tr2i18n("To use the irc protocol, just make up an account name.  This protocol has no real networking capability.", 0));
...
namespace Ui {
    class ircAccountPreferences: public Ui_ircAccountPreferences {};
} // namespace Ui

QT_END_NAMESPACE

#endif // IRCACCOUNTPREFERENCES_H

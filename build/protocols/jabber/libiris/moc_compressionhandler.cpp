...
#include "../../../../protocols/jabber/libiris/src/xmpp/xmpp-core/compressionhandler.h"
...
void CompressionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CompressionHandler *_t = static_cast<CompressionHandler *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData CompressionHandler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CompressionHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CompressionHandler,
      qt_meta_data_CompressionHandler, &staticMetaObjectExtraData }
};

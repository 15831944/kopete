...
#include "../../../../protocols/jabber/libiris/src/irisnet/noncore/icelocaltransport.h"
...
void XMPP::IceLocalTransport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IceLocalTransport *_t = static_cast<IceLocalTransport *>(_o);
        switch (_id) {
        case 0: _t->addressesChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData XMPP::IceLocalTransport::staticMetaObjectExtraData = {
...
const QMetaObject XMPP::IceLocalTransport::staticMetaObject = {
    { &IceTransport::staticMetaObject, qt_meta_stringdata_XMPP__IceLocalTransport,
      qt_meta_data_XMPP__IceLocalTransport, &staticMetaObjectExtraData }
};

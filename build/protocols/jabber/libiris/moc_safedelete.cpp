...
#include "../../../../protocols/jabber/libiris/src/irisnet/noncore/legacy/safedelete.h"
...
void SafeDeleteLater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SafeDeleteLater *_t = static_cast<SafeDeleteLater *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData SafeDeleteLater::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SafeDeleteLater::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SafeDeleteLater,
      qt_meta_data_SafeDeleteLater, &staticMetaObjectExtraData }
};

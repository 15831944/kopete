...
class KOPETE_EXPORT BehaviorSettings : public KConfigSkeleton
{
  public:
    ...
    */
    static
    void setShowContactName( bool v )
    {
      if (!self()->isImmutable( QString::fromLatin1( "ShowContactName" ) ))
        self()->mShowContactName = v;
    }
    ...
    */
    static
    void setHoverClose( bool v )
    {
      if (!self()->isImmutable( QString::fromLatin1( "HoverClose" ) ))
        self()->mHoverClose = v;
    }
  ...
  private:
    ...
    ItemBool *mShowContactNameItem;
    ItemBool *mHoverCloseItem;
};
